...
import './App.css';
import img_elNewGoalStep from './images/Goals2Screen_elNewGoalStep.jpg';

// UI framework component imports
import Button from 'muicss/lib/react/button';


export default class Goals2Screen extends Component {
  ...
  onClick_button = (ev) => {
    // Go to screen 'Goals 3'
    this.props.appActions.goToScreen('goals3', { transitionId: '_default' });
  ...
  render() {
    ...
    return (
      <div className="AppScreen Goals2Screen" style={baseStyle}>
