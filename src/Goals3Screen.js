...
import './App.css';
import img_elNewGoalStep from './images/Goals3Screen_elNewGoalStep.jpg';

// UI framework component imports
import Button from 'muicss/lib/react/button';


export default class Goals3Screen extends Component {
  ...
  onClick_button = (ev) => {
    // Go to screen 'Goals 4'
    this.props.appActions.goToScreen('goals4', { transitionId: 'fadeIn' });
  ...
  render() {
    ...
    return (
      <div className="AppScreen Goals3Screen" style={baseStyle}>
